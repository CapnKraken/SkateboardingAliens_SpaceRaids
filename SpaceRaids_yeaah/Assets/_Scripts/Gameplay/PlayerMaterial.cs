...
public class PlayerMaterial : MonoBehaviour
{
    ...
    private BuildMode buildMode; //buildmode script
    ...
    void Start()
    {
        ...
        buildMode = GetComponent<BuildMode>(); //get the buildmode script from the player
    }
    ...
    void Update()
    {
        ...
        if (!GameManager.Instance.pauseManager.isPaused()) //if it's not paused
        {
            ...
            if (!buildMode.isBuildModeActive()) //if not in build mode
            {
